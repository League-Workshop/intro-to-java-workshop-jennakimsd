...
public class OwnAdventure {
	...
	JOptionPane.showMessageDialog(null, "Ok, " + player + ". You are roaming through the forest when you come across a split in the path you are following. You can either walk through the forest (straight) or keep on the path you are on going either left or right.");
